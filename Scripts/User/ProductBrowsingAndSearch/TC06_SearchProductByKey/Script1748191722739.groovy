...
//	WebUI.maximizeWindow()
	...
	'1. Search full text'
	WebUI.setText(findTestObject('Object Repository/User/Search/input_search'), dataSearch)
	...
	fc.scrollDown()
	fc.scrollDown()
	WebUI.setText(findTestObject('Object Repository/User/Search/input_search'), "The Family")
	WebUI.click(findTestObject('Object Repository/User/Search/btn_search'))
	WebUI.delay(3)
	fc.scrollDown()
	...
	if(ListSeached.size() > 0) {
		...
		// Lấy tên và giá sản phẩm thực tế
		actualTitle = WebUI.getText(findTestObject('Object Repository/User/Product/product_tittle'))
		 actualPrice = WebUI.getText(findTestObject('Object Repository/User/Product/product_detail_price'))
	...
	fc.scrollDown()
	fc.scrollDown()
	WebUI.setText(findTestObject('Object Repository/User/Search/input_search'), "aaa")
	WebUI.click(findTestObject('Object Repository/User/Search/btn_search'))
	WebUI.delay(3)
	fc.scrollDown()
