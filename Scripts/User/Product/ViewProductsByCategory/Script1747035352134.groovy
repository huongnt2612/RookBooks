...
//	WebUI.verifyElementText(findTestObject('Object Repository/HomePage/tittle_category_2'), 'SÁCH MỚI')
	...
	String listXpath = findTestObject('Object Repository/HomePage/list_tittle_books').findPropertyValue('xpath')
	...
	String titleXpath0 = findTestObject('Object Repository/HomePage/tittle_category_item_1').findPropertyValue('xpath')
	String currentPriceXpath0 = findTestObject('HomePage/current_price_item_1').findPropertyValue('xpath')
	String oldPriceXpath0 = findTestObject('HomePage/old_price_item_1').findPropertyValue('xpath')
	...
	// Từ object repository, lấy xpath tương ứng
	String titleXpath1 = findTestObject('Object Repository/HomePage/tittle_category_item_2').findPropertyValue('xpath')
	String currentPriceXpath1 = findTestObject('Object Repository/HomePage/current_price_item_2').findPropertyValue('xpath')
	String oldPriceXpath1 = findTestObject('Object Repository/HomePage/old_price_item_2').findPropertyValue('xpath')
